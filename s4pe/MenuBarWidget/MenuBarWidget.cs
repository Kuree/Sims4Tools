...
namespace S4PIDemoFE
{
    public partial class MenuBarWidget : UserControl
    {
        ...
        public MenuBarWidget()
        {
            ...
            Checked(MenuBarWidget.MB.MBS_previewDDS, S4PIDemoFE.Properties.Settings.Default.EnableDDSPreview);
            Checked(MenuBarWidget.MB.MBS_fallbackTextPreview, S4PIDemoFE.Properties.Settings.Default.EnableFallbackTextPreview);
            Checked(MenuBarWidget.MB.MBS_fallbackHexPreview, S4PIDemoFE.Properties.Settings.Default.EnableFallbackHexPreview);
        }
        ...
        private void SetHelpers(ToolStripItemCollection dropdown, ToolStripItem tss, string prefix, IEnumerable<s4pi.Helpers.HelperManager.Helper> helpers)
        {
        ...
        public void SetHelpers(IEnumerable<s4pi.Helpers.HelperManager.Helper> helpers)
        {
        ...
        {
            if (S4PIDemoFE.Properties.Settings.Default.MRUList == null)
                S4PIDemoFE.Properties.Settings.Default.MRUList = new System.Collections.Specialized.StringCollection();
            if (S4PIDemoFE.Properties.Settings.Default.MRUList.Contains(value))
                S4PIDemoFE.Properties.Settings.Default.MRUList.Remove(value);
            S4PIDemoFE.Properties.Settings.Default.MRUList.Insert(0, value);
            while (S4PIDemoFE.Properties.Settings.Default.MRUList.Count > S4PIDemoFE.Properties.Settings.Default.MRUListSize)
                S4PIDemoFE.Properties.Settings.Default.MRUList.RemoveAt(S4PIDemoFE.Properties.Settings.Default.MRUList.Count - 1);
            UpdateMRUList();
        }
        void UpdateMRUList()
        {
            ...
            int i = 0;
            if (S4PIDemoFE.Properties.Settings.Default.MRUList != null)
                foreach (string f in S4PIDemoFE.Properties.Settings.Default.MRUList)
                {
                    string s = makeName(f);
        ...
        protected void OnMRUClick(object sender, int i) { if (MRUClick != null) MRUClick(sender, new MRUClickEventArgs(S4PIDemoFE.Properties.Settings.Default.MRUList[i])); }
        ...
        public void AddBookmark(string value)
        {
            ...
            if (S4PIDemoFE.Properties.Settings.Default.Bookmarks.Contains(value))
                S4PIDemoFE.Properties.Settings.Default.Bookmarks.Remove(value);
            S4PIDemoFE.Properties.Settings.Default.Bookmarks.Insert(0, value);
        ...
        public void UpdateBookmarks()
        {
            ...
            int i = 0;
            if (S4PIDemoFE.Properties.Settings.Default.Bookmarks != null)
                foreach (string f in S4PIDemoFE.Properties.Settings.Default.Bookmarks)
                {
                    string s = makeName(f);
        ...
        protected void OnBookmarkClick(object sender, int i) { if (BookmarkClick != null) BookmarkClick(sender, new BookmarkClickEventArgs(S4PIDemoFE.Properties.Settings.Default.Bookmarks[i])); }
