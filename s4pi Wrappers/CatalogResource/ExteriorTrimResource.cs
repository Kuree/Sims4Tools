...
{
    class ExteriorTrimResource : ObjectCatalogResource
    {
        #region Attributes
        ...
        public ExteriorTrimResource(int APIversion, Stream s) : base(APIversion, s) { }
        ...
        [ElementPriority(18)]
        public TGIBlock ModlTGIReference { get { return modlTGIReference; } set { if (!modlTGIReference.Equals(value)) { OnResourceChanged(this, EventArgs.Empty); this.modlTGIReference = value; } } }
        [ElementPriority(19)]
