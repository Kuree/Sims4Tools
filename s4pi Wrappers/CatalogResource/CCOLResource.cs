...
{
    public class CCOLResource : AResource
    {
        #region Attributes
        ...
        private uint unk10; // v0x19
        private uint unk11; // v0x19
        private uint unk12; // v0x19
        private uint unk13; // v0x19
        private uint unk14;
        ...
        public uint Unk14
        {
            ...
            set
            {
                if (unk14 != value)
                {
                    unk14 = value; OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        [ElementPriority(43)]
        public uint ReferencesIndicator
        {
            ...
            set
            {
                if (refIndicator != value)
                {
                    refIndicator = value; OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        [ElementPriority(44)]
        public Gp9references MODLRefs
        {
            ...
            set
            {
                if (modlRefs != value)
                {
                    modlRefs = new Gp9references(kRecommendedApiVersion,this.OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        [ElementPriority(45)]
        public Gp9references FTPTRefs
        {
            ...
            set
            {
                if (ftptRefs != value)
                {
                    ftptRefs = new Gp9references(kRecommendedApiVersion, this.OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
        [ElementPriority(46)]
        public Gp4references NullRefs
        {
            ...
            set
            {
                if (nullRefs != value)
                {
                    nullRefs = new Gp4references(kRecommendedApiVersion, this.OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty);
                }
            }
        }
