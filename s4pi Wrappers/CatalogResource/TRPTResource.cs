...
{
    public class TRPTResource : AResource
    {
        ...
        {
            get { return hash01; }
            set { hash01 = value; this.OnResourceChanged(this, EventArgs.Empty); }
        }
        [ElementPriority(22)]
        public uint Hash02
        {
            get { return hash02; }
            set { hash02 = value; this.OnResourceChanged(this, EventArgs.Empty); }
        }
        [ElementPriority(23)]
        public uint Hash03
        {
            get { return hash03; }
            set { hash03 = value; this.OnResourceChanged(this, EventArgs.Empty); }
        }

        [ElementPriority(25)]
        public MATDEntryList MaterialList
        {
            get { return matdList; }
        ...
        {
            get { return unk16; }
            set { unk16 = value; this.OnResourceChanged(this, EventArgs.Empty); }
        }
        ...
        */
        ...
        public class MATDEntry : AHandlerElement, IEquatable<MATDEntry>
        {
            ...
            */
            ...
            public MATDEntry(int APIversion, EventHandler handler, MATDEntry other)
                : this(APIversion, handler, other.matdRef)
            {
            }
            ...
            public MATDEntry(int APIversion, EventHandler handler, TGIBlock mlodRef)
                : base(APIversion, handler)
            {
                //this.mlodLabel = mlodLabel;
                this.matdRef = mlodRef;
            }
            ...
            {
                return this.matdRef == other.matdRef;
            }
        ...
        #region Constructors
        public TRPTResource(int APIversion, Stream s)
            : base(APIversion, s)
        {
            this.Parse(s);
        }
    ...
    /// </summary>
    public class TRPTResourceHandler : AResourceHandler
    {
        public TRPTResourceHandler()
        {
            this.Add(typeof(TRPTResource), new List<string>(new string[] { "0xEBCBB16C", }));
        }
    }
}