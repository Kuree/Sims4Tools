...
namespace RCOLResource
{
    public class FTPT : RCOLChunk
    {
        ...
        protected override void Parse(System.IO.Stream s)
        {
            ...
            footprintAreas = new AreaList(null, s, version);
            slotAreas = new AreaList(null, s, version);
        }
        ...
        protected override void UnParse(Stream s)
        {
            ...
            w.Write(version);
            if (footprintAreas == null) footprintAreas = new AreaList(null, version);
            footprintAreas.UnParse(s);
            if (slotAreas == null) slotAreas = new AreaList(null, version);
            slotAreas.UnParse(s);
        }
        ...
        #region Content Fields
        [ElementPriority(11)]
        public uint Version { get { return version; } set { if (version != value) { version = value; footprintAreas.ParentVersion = version; slotAreas.ParentVersion = version; OnElementChanged(); } } }
        [ElementPriority(12)]
        public AreaList FootprintAreas { get { return footprintAreas; } set { if (footprintAreas != value) { footprintAreas = value; ; OnElementChanged(); } } }
        [ElementPriority(13)]
        public AreaList SlotAreas { get { return slotAreas; } set { if (slotAreas != value) { slotAreas = value; OnElementChanged(); } } }
